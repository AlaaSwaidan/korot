        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">البنوك</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_subscriptions_table">
                        ...
                        <tr>
                            ...
                            <!--end::Customer=-->
                            <td>
                                {{ $value->type == "cash" ? "كاش" : "بنك" }}
                            </td>
                            <!--begin::email=-->
                            <td>
                                <div class="badge badge-light">{{ $value->account_number ?? '--' }}</div>
                            </td>
                            <!--end::email=-->
                            <!--begin::Date=-->
            ...
            <!--end::Svg Icon--></a>
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="{{ route('admin.banks.edit',$value->id) }}" class="menu-link px-3">تعديل</a>
                                    </div>
                                    <!--end::Menu item-->
                                    @if($value->id != 1)
                                        <!--begin::Menu item-->
...
{{--    <script src="{{ URL::asset('admin/assets/js/custom/apps/subscriptions/list/list.js') }}"></script>--}}
    ...
    <script>
        var page_name = 'البنوك';
        var selected_url_delete = "{{ url('/') }}" + "/admin/banks/selected/destroy" ;
