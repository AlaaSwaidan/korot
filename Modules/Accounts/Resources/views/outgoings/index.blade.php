                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-subscription-table-toolbar="base">
                            ...
                            <a href="{{ route('admin.outgoings.create') }}" class="btn btn-primary">
                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_subscriptions_table">
                        ...
                        <tr>
                            ...
                            <td> {{ $value->confirm == 0 ? "لم يتم التأكيد" : "تم تأكيد"}} </td>
            ...
            <!--end::Svg Icon--></a>
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="{{ route('admin.outgoings.edit',$value->id) }}" class="menu-link px-3">تعديل</a>
                                    </div>
                                    <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="{{ route('admin.outgoings.confirm-page',$value->id) }}" class="menu-link px-3">تأكيد الفاتورة</a>
                                        </div>
                                        <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a  data="{{ $value->id }}" data_name="{{$value->invoice_id }}"   class="menu-link text-danger px-3 delete_row">حذف</a>
                                    </div>
                                    ...
                                    @else
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="{{ route('admin.outgoings.show',$value->id) }}" class="menu-link px-3">عرض</a>
                                        </div>
                                        <!--end::Menu item-->
                                    @endif
...
{{--    <script src="{{ URL::asset('admin/assets/js/custom/apps/subscriptions/list/list.js') }}"></script>--}}
    ...
    <script>
        var page_name = 'المصروفات';
        var selected_url_delete = "{{ url('/') }}" + "/admin/outgoings/selected/destroy" ;
            ...
            $('body').on('click', '.delete_row', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            url: "{{ url('/') }}" + "/admin/outgoings/destroy" ,
                            type: "POST",
