...
{{--    <script src="{{ URL::asset('admin/assets/js/custom/apps/subscriptions/list/list.js') }}"></script>--}}
    ...
    <script>
        var page_name = 'أوامر الشراء';
        var selected_url_delete = "{{ url('/') }}" + "/admin/purchase-orders/selected/destroy" ;
            ...
            $('body').on('click', '.delete_row', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            url: "{{ url('/') }}" + "/admin/purchase-orders/destroy" ,
                            type: "POST",
