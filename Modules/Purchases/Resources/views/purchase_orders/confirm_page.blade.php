    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card card-flush">
                {!! Form::model($purchaseOrder, ['method' => 'PATCH', 'url' => route('admin.purchase-orders.confirm', $purchaseOrder->id),'class' => 'form-horizontal','files'=>'true','id'=>'add-invoice']) !!}
                @include('purchases::purchase_orders._form_confirm')
                {!! Form::close() !!}
            </div>
            <!--end::Card-->
        </div>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data['packages'].length > 0) {
                        ...
                        cols += '<td style="padding: 0;"> <input type="text"  id="discount_amount[' + i + ']" name="discount_amount[' + i + ']" class="form-control tax_percediscount_amountntage" placeholder="نسبة الخصم" value="0" > </td>';
