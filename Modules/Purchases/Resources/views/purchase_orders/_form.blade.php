                ...
                @if( isset($purchaseOrder) )
                    ...
                    @foreach($purchaseProducts as $data)
                        ...
                        <tr>
                            ...
                            <td style="padding: 0;">
                                <input type="text" id="discount_amount[{{$i}}]"   name="discount_amount[{{$i}}]" class="form-control  discount_amount" placeholder="ملغ الخصم" value="{{isset($purchaseOrder) ? $data->discount_amount : 0 }}"  parsley-trigger="change" required />
                            </td>
