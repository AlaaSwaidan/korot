    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                <!--begin::Form-->
                <form action="{{ route('admin.admins.profile-collections-search',$admin->id) }}">
                    <!--begin::Card-->
                    <div class="card mb-7">
                        <!--begin::Card body-->
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <input type="hidden" name="type_collection" value="from_dis">
                                <!--end::Input group-->
                                <!--begin:Action-->
                                <div class="d-flex">
                ...
                <div class="card-body pt-0">
                    <form action="{{route('admin.admins.profile-collections-excel')}}" method="post" >
                        @csrf
