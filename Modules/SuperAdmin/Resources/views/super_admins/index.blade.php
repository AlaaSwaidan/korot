        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">مدير النظام</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_subscriptions_table">
                        ...
                        <tr>
                            ...
                            <!--begin::Customer=-->
                            <td>
                                <a href="{{ route('admin.super-admins.show',$value->id) }}" class="text-gray-800 text-hover-primary mb-1">{{ $value->name }}</a>
                            </td>
                            <!--end::Customer=-->
                            <!--begin::Status=-->
                            <td>
            ...
            <!--end::Svg Icon--></a>
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="{{ route('admin.super-admins.show',$value->id) }}" class="menu-link px-3">عرض</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="{{ route('admin.super-admins.edit',$value->id) }}" class="menu-link px-3">تعديل</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="{{ route('admin.super-admins.change-password',$value->id) }}" class="menu-link px-3">تغيير كلمة المرور</a>
                                    </div>
                                    <!--end::Menu item-->
                                    @if($value->id != 1)
                                    <!--begin::Menu item-->
            ...
            $('body').on('click', '.delete_row', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            url: "{{ url('/') }}" + "/admin/super-admins/destroy" ,
                            type: "POST",
