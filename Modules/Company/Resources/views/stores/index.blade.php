    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <!--begin::Title-->
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">الشركات</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_subscriptions_table">
                        ...
                        <tr>
                                ...
                                <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                    <a href="{{ $value->image_full_path }}">
                                        <div class="symbol-label">
                                            <img src="{{ $value->image_full_path }}" alt="{{ $value->name['ar'] }}" class="w-100">
                                        </div>
                                    </a>
                                </div>
                                @endif
                            ...
                            <td>
                                @foreach($value->departments as $storeName)
                                   <span class="alert alert-info"> {{ $storeName[app()->getLocale()] ?? $storeName['ar'] }}@if(!$loop->last), @endif</span>
                                @endforeach
                            </td>
                            <!--end::Customer=-->
                            <td>
                                <button type="button" onclick="window.location.href='{{ route('admin.categories.index',$value->id) }}'" class="btn btn-lg btn-secondary" data-kt-stepper-action="next">
                            ...
                            <td>
                                <div class="badge badge-light-info">  {{ $value->arrangement }}</div>
                            </td>
...
{{--                                        <a href="{{ route('admin.stores.show',$value->id) }}" class="menu-link px-3">عرض</a>--}}
{{--                                    </div>--}}
{{--                                    <!--end::Menu item-->--}}
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="{{ route('admin.stores.edit',$value->id) }}" class="menu-link px-3">تعديل</a>
                                    </div>
                                    <!--end::Menu item-->

                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a  data="{{ $value->id }}" data_name="{{$value->name['ar'] }}"   class="menu-link text-danger px-3 delete_row">حذف</a>
                                    </div>
...
{{--    <script src="{{ URL::asset('admin/assets/js/custom/apps/subscriptions/list/list.js') }}"></script>--}}
    ...
    <script>
        var page_name = 'الشركات';
        var selected_url_delete = "{{ url('/') }}" + "/admin/stores/selected/destroy" ;
