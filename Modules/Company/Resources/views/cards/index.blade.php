...
@section('content')
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            <!--begin::Form-->
            <form action="{{ route('admin.cards.search',$package->id) }}">
                <!--begin::Card-->
                <div class="card mb-7">
                    <!--begin::Card body-->
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="position-relative w-md-400px me-md-2">
                                ...
                                <!--end::Svg Icon-->
                                <input type="text" class="form-control form-control-solid ps-10" name="serial_num" value="{{ isset($serial_num) ? $serial_num : '' }}" placeholder="البحث" />
                            </div>
                            <!--end::Input group-->
                            <!--begin:Action-->
                            <div class="d-flex align-items-center">
...
{{--                    </div>--}}
                    ...
                    <div class="card-toolbar">
                        ...
                        <button type="button" class="btn btn-danger me-3" data-bs-toggle="modal" data-bs-target="#kt_delete_modal">
                            <i class="la la-times"></i>
                            حذف كل المخزون</button>

                        <!--end::delete-->
                        <div class="d-flex justify-content-end" data-kt-subscription-table-toolbar="base">
                            <!--begin::Export-->
                            <form action="{{ route('admin.cards.export') }}" method="post" >
                                @csrf
                            ...
                            <!--end::Export-->
                            <!--begin::import-->
                            <button type="button" class="btn btn-light-primary me-3" data-bs-toggle="modal" data-bs-target="#kt_subscriptions_import_modal">
                                <!--begin::Svg Icon | path: icons/duotune/arrows/arr078.svg-->
                                <span class="svg-icon svg-icon-2">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <rect opacity="0.3" x="12.75" y="4.25" width="12" height="2" rx="1" transform="rotate(90 12.75 4.25)" fill="currentColor" />
                            ...
                            <a href="{{ route('admin.cards.create',$package->id) }}" class="btn btn-primary">
...
{{--                                    <!--end::Menu item-->--}}
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="{{ route('admin.cards.edit',$value->id) }}" class="menu-link px-3">تعديل</a>
                                    </div>
                                    <!--end::Menu item-->
...
{{--    <script src="{{ URL::asset('admin/assets/js/custom/apps/subscriptions/list/list.js') }}"></script>--}}
    ...
    <script>
        ...
        var page_name = 'البطاقات';
        var selected_url_delete = "{{ url('/') }}" + "/admin/cards/selected/destroy" ;
