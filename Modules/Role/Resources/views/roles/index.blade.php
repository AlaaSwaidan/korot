                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_subscriptions_table">
                        ...
                        @foreach($data as $value )
                            ...
                            <tr>
                                ...
                                <!--begin::Customer=-->
                                <td>
                                    <a href="{{ route('admin.roles.show',$value->id) }}"
                                ...
                                <td >
                                    ...
                                    <div
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="{{ route('admin.roles.show',$value->id) }}" class="menu-link px-3">عرض</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        ...
                                        @if($value->name != 'super-admin')
                                            ...
                                            @if($value->id != 1)
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                                    <a data="{{ $value->id }}" data_name="{{$value->name }}"
                                                       class="menu-link text-danger px-3 delete_row">حذف</a>
                                                </div>
                                            @endif
                                        @endif
                                        <!--end::Menu item-->
