        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <!--begin::Item-->
                    <li class="breadcrumb-item">
                        <a href="{{ route('admin.transfers.index','type=merchants') }}" class="text-muted text-hover-primary">تحويلات التجار</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">تحويلات {{ $merchant->name }}</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
...
@section('content')
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <!--begin::Form-->
            <form action="{{ route('admin.transfers.search.merchant',$merchant->id) }}" >
                <!--begin::Card-->
                <div class="card mb-7">
                    <!--begin::Card body-->
                    <div class="card-body">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_subscriptions_table">
                        ...
                        @foreach($data as $value )
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.transfers.balance-merchant-pdf', $value->id) }}" target="_blank" class="text-gray-800 text-hover-primary mb-1">وصل التحويل</a>
                                </td>
