    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <!--begin::Title-->
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">التحويل </h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">
                        <a href="{{ route('admin.transfers.index','type='.$type) }}" class="text-muted text-hover-primary">التحويل</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item"><strong>إضافة تحويل للموزع {{ $distributor->name }}</strong> </li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card card-flush">
                {!! Form::open([ 'url' => route('admin.transfers.store-transfer-distributors',$distributor), 'class' => 'form-horizontal'  ]) !!}
                @include('transfers::transfers_distributors._form')
                {!! Form::close() !!}
            </div>
            <!--end::Card-->
        </div>
...
@section('scripts')
    <script>
        ...
        $( "body" ).on( "change", "select[name='transfer_type']", function() {
            var id = $(this).val();
            if(id == "fawry"){
                $('#banks').empty();
