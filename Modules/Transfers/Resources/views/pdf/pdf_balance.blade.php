...
<table style="width:100%;border:none;">
    <tr>
        ...
        <td style="text-align:left;">
         ...
         <br/>
         <span style="color:red;">{!! $transfer->transfer_type == "fawry" ? "محصل" : "غير محصل" !!}</span><br/>
         <span style="color:red;">{!! $transfer->transfer_type == "fawry"  ? ($transfer->bank_name  ? 'البنك : '.$transfer->bank->name['ar'] : '') : ''  !!}</span>
