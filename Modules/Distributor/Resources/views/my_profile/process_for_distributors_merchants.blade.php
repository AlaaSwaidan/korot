    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                ...
                <!--begin::Form-->
                <form action="{{ route('admin.distributors.search-by-all-distributors-process',$distributor->id) }}">
                    <!--begin::Card-->
                    <div class="card mb-7">
                        <!--begin::Card body-->
                        <div class="card-body">
                ...
                <div class="card-body pt-0">
                    <div class="d-flex flex-column flex-sm-row d-grid gap-2">
                        <span  class="btn btn-success flex-shrink-0 me-lg-2">اجمالي التحويلات : {{ $total_transfers }} </span>
                        <span  class="btn btn-primary flex-shrink-0 me-lg-2"  >اجمالي التحصيلات :{{ $total_collection }} </span>
                    </div>
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_subscriptions_table">
                        ...
                        @foreach($data as $value )
                            ...
                            <tr>
                                ...
                                <!--end::Customer=-->
                                <td>
                                    {{ $value->type == "transfer" ? "تحويل"  : "تحصيل"}}
                                </td>
                                <td>
                                ...
                                <td>
                                    <a href="{{ route('admin.transfers.balance-distributors-pdf', $value->id) }}" target="_blank" class="text-gray-800 text-hover-primary mb-1">وصل التحويل</a>
                                </td>
