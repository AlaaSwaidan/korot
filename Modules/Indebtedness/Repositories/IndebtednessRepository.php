...
class IndebtednessRepository
{

    public function index($user)
    {

        $data =$user->userable()->whereIn('type',['indebtedness','repayment'])->Order()->paginate(20)->appends(request()->except('page'));
        return $data;
    }
    ...
    public function search($request,$user)
    {
        ...
        $data = $user->userable()->whereIn('type',['indebtedness','repayment'])->Order();
