        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">تعويضات ومديونيات {{ $distributor->name }}</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
...
@section('content')
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            <!--begin::Form-->
            <form action="{{ route('admin.indebtedness.search.distributor',$distributor->id) }}" >
                <!--begin::Card-->
                <div class="card mb-7">
                    <!--begin::Card body-->
                    <div class="card-body">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_subscriptions_table">
                        ...
                        @foreach($data as $value )
                            ...
                            <tr>
                                ...
                                <td>
                                    {{ $value->type == "repayment" ? "تعويض" : "مديونية" }}
                                </td>

                                <td>
                                    @if($value->type == "repayment")
                                        <a href="{{ route('admin.indebtedness.balance-merchant-pdf', $value->id) }}" target="_blank" class="text-gray-800 text-hover-primary mb-1">الوصل</a>
                                    @else
                                        ---
                                    @endif
                                </td>
