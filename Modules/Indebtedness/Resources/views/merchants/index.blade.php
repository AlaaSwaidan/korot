    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                <!--begin::Title-->
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">تعويضات ومديونيات
                    {{ $name }}</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">تعويضات ومديونيات  {{ $name }}</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
                        ...
                        <tr>
                            ...
                            <td class="d-flex align-items-center">
                                ...
                                <div class="d-flex flex-column">
                                    <a href="{{ route('admin.'.$type.'.show',$value->id) }}" class="text-gray-800 text-hover-primary mb-1">{{ $value->name }}</a>
                            ...
                            <!--end::Customer=-->
                            <td>
                                <div class="badge badge-light-info">  {{ $value->balance }}</div>
                            </td>
                            <!--begin::Status=-->
                            <td>
                                <div class="badge badge-light-danger">{{ $value->indebtedness}}</div>
                            </td>
                            <!--end::Status=-->
                            <!--begin::email=-->
                            <td>
                                <div class="badge badge-light">{{ $value->repayment_total }}</div>
                            </td>
                            <!--end::email=-->
                            <!--begin::Action=-->
                            <td >
            ...
            <!--end::Svg Icon--></a>
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="{{ route('admin.indebtedness.add-indebtedness-'.$type,$value->id) }}" class="menu-link px-3">اضافة مديونية</a>
                                    </div>
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="{{ route('admin.indebtedness.add-repayment-'.$type,$value->id) }}" class="menu-link px-3">اضافة تعويض</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="{{ route('admin.indebtedness.view-indebtedness-'.$type,$value->id) }}" class="menu-link px-3">عرض التعويضات والمديونيات </a>
                                    </div>
                                    <!--end::Menu item-->
