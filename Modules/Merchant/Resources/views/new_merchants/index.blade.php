        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_subscriptions_table">
                        ...
                        <tr>
                            ...
                            <!--end::Customer=-->
                            <td>
                                <div class="badge badge-light-info">  {{ added_by_type($value->added_by_type,$value) }}</div>
                            </td>
                            <!--begin::Status=-->
                            <td>
                                <div class="badge badge-light-{{ $value->approve == 1 ?  'success' : "danger"}}">{{ $value->approve == 1 ? "قبول " : "لم يتم قبوله"}}</div>
                            </td>
                            <!--end::Status=-->
                            <!--begin::email=-->
                            <td>
            ...
            <!--end::Svg Icon--></a>
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a data="{{ $value->id }}" data_name="{{$value->name }}" class="menu-link px-3 change_approve" >قبول / رفض</a>
                                    </div>
                                    <!--end::Menu item-->
...
{{--    <script src="{{ URL::asset('admin/assets/js/custom/apps/subscriptions/list/list.js') }}"></script>--}}
    ...
    <script>
        var page_name = 'تجار في انتظار الموافقة';
        var selected_url_delete = "{{ url('/') }}" + "/admin/merchants/new/selected/destroy" ;
        ...
        $(document).ready(function() {
            ...
            $('body').on('click', '.delete_row', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            url: "{{ url('/') }}" + "/admin/merchants/new/destroy" ,
                            type: "POST",
            ...
            $('body').on('click', '.change_approve', function() {
                ...
                // SweetAlert2 pop up --- official docs reference: https://sweetalert2.github.io/
                Swal.fire({
                    text: "هل أنت متأكد من قبول  " + name + " ؟ ",
                    icon: "warning",
                    showCancelButton: true,
                    buttonsStyling: false,
                    confirmButtonText: "تأكيد",
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            url: "{{ url('/') }}" + "/admin/merchants/accept-approve" ,
                            type: "POST",
                            data: {_token: CSRF_TOKEN, 'id': id},
                        })
                            .done(function(reseived_data) {
