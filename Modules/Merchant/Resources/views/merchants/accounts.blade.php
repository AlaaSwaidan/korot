        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                ...
                <div class="card-header border-0 pt-6">
                    @include('merchant::merchants.search_form')
                    <!--begin::Card toolbar-->
...
{{--                                </td>--}}
                                ...
                                <td>
                                    <div class="badge badge-light-dark">
                                        ...
                                        {{ $last_data->filter(function ($item) {
                                        return $item->type === 'sales'
                                        && $item->order_id !== null
                                        && $item->order && $item->order->payment_method === 'online';
                                        })->sum('amount')
                                         }}
                                    </div>
                                </td>
                                <td>
                                    <div class="badge badge-light-dark">
                                      {{ $last_data->filter(function ($item) {
                                                return $item->type === 'sales'
                                                    && $item->order_id !== null
                                                    && $item->order && $item->order->payment_method === 'wallet';
                                            })->sum('amount') }}
                                    </div>
                                </td>
                                                ...
                                                <div id="kt_job_{{$value->first()->id}}" class="collapse fs-6 ms-1">
                                                    ...
                                                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_subscriptions_table">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td> 1 </td>
                                                            <td>
                                                                <div class="badge badge-light-success">{{ getDayBefore($merchant,$startDate,$endDate,$value) }}</div>
                                                            </td>
                                                            <td>
                                                                {{ $value->count() }}
