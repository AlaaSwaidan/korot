...
class AdminTransferExport implements FromCollection, WithHeadings, WithMapping, ShouldAutoSize, WithEvents
{
    /**
    ...
    */
    function __construct($data) {
        ...
        $this->type_transfers = $data->type_transfers;
        $this->type = $data->type;
    ...
    public function collection()
    {
        ...
        if ($this->type_transfers == "from_dis"){
            $data =$user->providerable()->where('type','transfer')->Order();
        }else{
