    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card card-flush">
                {!! Form::open([ 'url' => route('admin.update-password', $admin), 'class' => 'form-horizontal' ]) !!}
                <!--begin::Card body-->
                <div class="card-body">
                    <!--begin::Form-->
                    <!--begin::Input group-->
                    <div class="fv-row row mb-15">
                        ...
                        <div class="col-md-3 d-flex align-items-center">
                            <!--begin::Label-->
                            <label class="fs-6 fw-semibold">كلمة المرور الحالية</label>
                            <!--end::Label-->
                        </div>
                        <!--end::Col-->
                        <!--begin::Col-->
                        <div class="col-md-9">
                            <!--begin::Input-->
                            <input type="password"  class="form-control form-control-lg form-control-solid" name="current_password" placeholder="كلمة المرور الحالية"
                            >
                            <!--end::Input-->
                        </div>
                        <!--end::Col-->
