...
<table style="width:100%;border:1px solid #dee2e6;">
    <tr>
        <td style="border:1px solid #dee2e6;">
            <span>بيانات استلام مديونية</span>
            <br />
            <span><strong>  استلمت انا  {{ $transfer->fromAdmin->name }}  من {{ $to_user }}  التحصيل أدناه </strong></span>
            <br />
...
<table style="width:100%;border:1px solid #dee2e6;">
    ...
    <tr>
        ...
        <th style="background-color:#eee;text-align: center;border:1px solid #dee2e6;">اجمالي المبلغ المحصل</th>
